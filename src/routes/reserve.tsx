    ...
    <>
      <section className="bg-charcoal py-20 text-cream">
        <div className="mx-auto max-w-5xl px-5 text-center lg:px-8">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Prenotazioni</span>
          <h1 className="mt-4 font-display text-5xl font-bold md:text-6xl">Reserve your table</h1>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl bg-card p-8 shadow-soft">
              ...
              {submitted ? (
                <div className="mt-6 rounded-xl bg-secondary/70 p-6 text-center">
                ...
                <form onSubmit={handleSubmit} className="mt-6 grid gap-5">
                  ...
                  <button type="submit" className="rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-primary-foreground shadow-warm transition hover:scale-[1.02]">
        ...
        {/* Map */}
        <div className="mt-16 overflow-hidden rounded-3xl shadow-warm">
          <iframe
